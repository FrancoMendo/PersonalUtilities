...
export default function HomeTab({ navigation }: RootTabScreenProps<'TabOne'>) {
  ...
  return (
    <>
      ...
      <PopUp show={!!showPopUp} title={showPopUp?.title || ''} onCancell={() => setShowPopUp(null)}>
        <View style={{paddingHorizontal: widthInt(40)}}>
          <Text style={styles().textBold}>Actividad</Text>
          <TextInput
            style={{ borderColor: "#cfd8dc", borderWidth: 1, borderRadius: 15, paddingHorizontal: 15 }}
          ...
          <View style={{display: 'flex', flexDirection: 'row'}}>
            <TextInput
              style={{width: '30%', borderColor: "#cfd8dc", borderWidth: 1, borderRadius: 15, paddingHorizontal: 15 }}
              placeholder="Desde"
            />
            <TextInput
              style={{width: '30%', borderColor: "#cfd8dc", borderWidth: 1, borderRadius: 15, paddingHorizontal: 15 }}
